...
export function emailConfirmationPaiement({ nomClient, titreResidence, dateArrivee, dateDepart, montant, methodePaiement, lienConversation }) {
  const contenu = `
        ...
        ${
          methodePaiement
            ? `<tr>
                 ...
                 <td style="padding: 4px 0; text-align: right; font-weight: bold;">${methodePaiement}</td>
               </tr>`
            : ""
        }
        <tr>
